                    ...
                    <div class="modal-dialog modalcustom">
                        <div class="modal-content">
                            ...
                            <div class="modal-body modalcustom">
                                <div class="container modalcustom">
                                    ...
                                    <div class="row p-2">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" style="width: 15rem"
                                                v-model="AdvSearch.first_name"
                                                @input="complete_word('first_name_usrmgt')" />
                                            <div v-if="result_search_complete_word.first_name.length > 0"
                                                class="autocomplete-results"
                                                @mouseleave="clear_search_results('first_name_usrmgt')">
                                                <div class="autocomplete-item"
                                                    v-for="result in result_search_complete_word.first_name"
                                                    :key="result.id" @click="
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" style="width: 15rem"
                                                v-model="AdvSearch.last_name" @input="complete_word('last_name_usrmgt')" />
                                            <div v-if="result_search_complete_word.last_name.length > 0"
                                                class="autocomplete-results"
                                                @mouseleave="clear_search_results('last_name_usrmgt')">
                                                <div class="autocomplete-item"
                                                    v-for="result in result_search_complete_word.last_name" :key="result.id"
                                                    @click="
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" style="width: 15rem"
                                                v-model="AdvSearch.username" @input="complete_word('username_usrmgt')" />
                                            <div v-if="result_search_complete_word.username.length > 0"
                                                class="autocomplete-results"
                                                @mouseleave="clear_search_results('username_usrmgt')">
                                                <div class="autocomplete-item"
                                                    v-for="result in result_search_complete_word.username" :key="result.id"
                                                    @click="
                                    ...
                                    <div class="row p-2">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" style="width: 15rem"
                                                v-model="AdvSearch.email" @input="complete_word('email_usrmgt')" />
                                            <div v-if="result_search_complete_word.email.length > 0"
                                                class="autocomplete-results"
                                                @mouseleave="clear_search_results('email_usrmgt')">
                                                <div class="autocomplete-item"
                                                    v-for="result in result_search_complete_word.email" :key="result.id"
                                                    @click="selectResult_search(result, 'email_usrmgt')">
                                                    {{ result.result }}
                                                </div>
                                            </div>
                                        ...
                                        <div class="col">
                                            <select class="form-select form-select-sm" v-model="AdvSearch.branch_id"
                                                ...
                                                <option value=""></option>
                                                <option v-for="option in data_ddl.branch" :value="option.id"
                                                    :key="option.id">
                                                    {{ option.branch }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="row p-2">
                                        ...
                                        <div class="col">
                                            <select class="form-select form-select-sm" v-model="AdvSearch.position_id"
                                                style="width: 15rem; height: 2.5rem">
                                                <option value=""></option>
                                                <option v-for="option in data_ddl.position" :value="option.id"
                                                    :key="option.id">
                                                    {{ option.position }}
                                                </option>
                                            </select>
                          ...
                          :value="user_id" track-by="user_id" placeholder="เลือก" :deselectLabel=null>
                                        ...
                                        <div class="col">
                                            <select :key="rerenderKey" class="form-select form-select-sm"
                                                v-model="AdvSearch.department_id" style="width: 15rem; height: 2.5rem">
                                                <option value=""></option>
                          ...
                          :close-on-select="true" :value="id" track-by="id" placeholder="เลือก" :deselectLabel=null>
                                        ...
                                        <div class="col">
                                            <select class="form-select form-select-sm" v-model="AdvSearch.division_id"
                                                style="width: 15rem; height: 2.5rem">
                                                <option value=""></option>
                                                <option v-for="option in data_ddl.division" :value="option.id"
                                                    :key="option.id">
                                                    {{ option.division }}
                                                </option>
                                            </select>
                            ...
                            <div class="modal-footer pt-0 justify-content-center">
                                <div class="align-top pt-1 d-flex justify-content-center">
                                    <button class="btn btn-primary" style="width:4rem; height:2rem;" @click="AdvSearch_"
                                        type="button">ค้นหา</button><button class="btn btn-secondary"
                                        data-bs-dismiss="modal" type="reset" ref="CloseModalAdvSearch"
                    ...
                    <div class="modal-dialog modalcustom">
                        <div class="modal-content">
                                ...
                                <div class="container modalcustom">
                                    ...
                                    <div class="row p-2">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" style="width: 15rem"
                                                v-model="NewUser_vrf.first_name"
                                                @input="complete_word('first_name_usrmgt')" />
                                            <div v-if="result_search_complete_word.first_name.length > 0"
                                                class="autocomplete-results"
                                                @mouseleave="clear_search_results('first_name_usrmgt')">
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" style="width: 15rem"
                                                v-model="NewUser_vrf.username" @input="complete_word('username_usrmgt')" />
                                            <div v-if="result_search_complete_word.username.length > 0"
                                                class="autocomplete-results"
                                                @mouseleave="clear_search_results('username_usrmgt')">
                                                <div class="autocomplete-item"
                                    ...
                                    <div class="row p-2">
                                        ...
                                        <div class="col">
                                            ...
                                            <p v-if="VRF_error.employee_id && !NewUser_vrf.employee_id"
                                                class="error-message">
                                                กรุณากรอกข้อมูล
                                            </p>
                                        </div>
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" style="width: 15rem"
                                                v-model="NewUser_vrf.email" @input="complete_word('email_usrmgt')" />
                                            <div v-if="result_search_complete_word.email.length > 0"
                                                class="autocomplete-results"
                                                @mouseleave="clear_search_results('email_usrmgt')">
                                                <div class="autocomplete-item"
                          ...
                          :value="user_id" track-by="user_id" placeholder="เลือก" :deselectLabel=null>
                                            ...
                                            <p v-if="VRF_error.position_id && !NewUser_vrf.position_id"
                                                class="error-message">
                                                กรุณาเลือกข้อมูล
                                            </p>
                                        </div>
                          ...
                          :value="id" track-by="id" placeholder="เลือก" :deselectLabel=null >
                                            ...
                                            <p v-if="VRF_error.division_id && !NewUser_vrf.division_id"
                                                class="error-message">
                                                กรุณาเลือกข้อมูล
                                            </p>
                                        </div>
                    ...
                    <div class="modal-dialog modalcustom">
                        <div class="modal-content">
                                ...
                                <div class="container modalcustom">
                                    ...
                                    <div class="row p-2">
                                        ...
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" style="width: 15rem"
                                                v-model="Existing_vrfuser.first_name"
                                                @input="complete_word('first_name_usrmgt')" />
                                            <div v-if="result_search_complete_word.first_name.length > 0"
                                                class="autocomplete-results"
                                                @mouseleave="clear_search_results('first_name_usrmgt')">
                                            ...
                                            <p v-if="VRF_error.first_name && !Existing_vrfuser.first_name"
                                                class="error-message">
                                                กรุณากรอกข้อมูล
                                            </p>
                                        </div>
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" style="width: 15rem"
                                                v-model="Existing_vrfuser.last_name"
                                                @input="complete_word('last_name_usrmgt')" />
                                            <div v-if="result_search_complete_word.last_name.length > 0"
                                                class="autocomplete-results"
                                                @mouseleave="clear_search_results('last_name_usrmgt')">
                                            ...
                                            <p v-if="VRF_error.last_name && !Existing_vrfuser.last_name"
                                                class="error-message">
                                                กรุณากรอกข้อมูล
                                            </p>
                                        </div>
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" style="width: 15rem"
                                                v-model="Existing_vrfuser.username"
                                            ...
                                            <p v-if="VRF_error.username && !Existing_vrfuser.username"
                                                class="error-message">
                                                กรุณากรอกข้อมูล
                                            </p>
                                        </div>
                                    ...
                                    <div class="row p-2">
                                        ...
                                        <div class="col">
                                            ...
                                            <p v-if="VRF_error.employee_id && !Existing_vrfuser.employee_id"
                                                class="error-message">
                                                กรุณากรอกข้อมูล
                                            </p>
                                        </div>
                                        ...
                                        <div class="col">
                                            <input type="text" class="form-control" style="width: 15rem"
                                                v-model="Existing_vrfuser.email" @input="complete_word('email_usrmgt')" />
                                            <div v-if="result_search_complete_word.email.length > 0"
                                                class="autocomplete-results"
                                                @mouseleave="clear_search_results('email_usrmgt')">
                                                <div class="autocomplete-item"
                          ...
                          :value="user_id" track-by="user_id" placeholder="เลือก" :deselectLabel=null>
                                            ...
                                            <p v-if="VRF_error.branch_id && !Existing_vrfuser.branch_id"
                                                class="error-message">
                                                กรุณาเลือกข้อมูล
                                            </p>
                                        </div>
                                    ...
                                    <div class="row p-2">
                                        ...
                                        <div class="col">
                                            <select class="form-select form-select-sm"
                                                v-model="Existing_vrfuser.position_id" style="width: 15rem; height: 2.5rem">
                                                <option value=""></option>
                                                <option v-for="option in data_ddl.position" :value="option.id"
                                                    :key="option.id">
                                                    {{ option.position }}
                          ...
                          :value="user_id" track-by="user_id" placeholder="เลือก" :deselectLabel=null>
                                            ...
                                            <p v-if="VRF_error.position_id && !Existing_vrfuser.position_id"
                                                class="error-message">
                                                กรุณาเลือกข้อมูล
                                            </p>
                                        </div>
                                        ...
                                        <div class="col">
                                            <select class="form-select form-select-sm"
                                                v-model="Existing_vrfuser.department_id"
                                                style="width: 15rem; height: 2.5rem">
                                                <option value=""></option>
                                                <option v-for="option in data_ddl.dept" :value="option.id" :key="option.id">
                                                    {{ option.department }}
                          ...
                          :close-on-select="true" :value="id" track-by="id" placeholder="เลือก" :deselectLabel=null>
                                        ...
                                        <div class="col">
                                            <select class="form-select form-select-sm"
                                                v-model="Existing_vrfuser.division_id" style="width: 15rem; height: 2.5rem">
                                                <option value=""></option>
                                                <option v-for="option in data_ddl.division" :value="option.id"
                                                    :key="option.id">
                                                    {{ option.division }}
                          ...
                          :value="id" track-by="id" placeholder="เลือก" :deselectLabel=null >
                                            ...
                                            <p v-if="VRF_error.division_id && !Existing_vrfuser.division_id"
                                                class="error-message">
                                                กรุณาเลือกข้อมูล
                                            </p>
                                        </div>
...
export default defineComponent({
    ...
    setup() {
        ...
        const ClosemyModalNew_ = async () => {
            ...
            NewUser_vrf.department_id = localStorage.getItem('user_department_id')
            NewUser_vrf.division_id = localStorage.getItem('user_division_id')
            NewUser_vrf.branch_id = localStorage.getItem('user_branch_id')
            ...
            //---------------------------
            await nextTick();
            console.log('AdvSearch.department_id: ', Number(localStorage.getItem('user_department_id'))
                , 'AdvSearch.division_id: ', Number(localStorage.getItem('user_division_id'))
                , 'AdvSearch.branch_id: ', Number(localStorage.getItem('user_branch_id')))
        }
        //-----check session
        ...
        const myRequest = async (keyword) => {
            ...
            await axios
                .get(process.env.VUE_APP_API_URL + '/get_user_list_by_dept', { params })
                .then(
                    (res) => {
            ...
            await axios
                .get(process.env.VUE_APP_API_URL + '/get_role_by_dept', {
                    params: {
                        division_id: localStorage.getItem('user_division_id'),
                        branch_id: localStorage.getItem('user_branch_id'),
                        department_id: localStorage.getItem('user_department_id')
        ...
        const AdvSearch_ = async () => {
            ...
            await axios
                .get(process.env.VUE_APP_API_URL + '/get_search_user_vrf_by_dept', { params })
                .then(
                    (res) => {
