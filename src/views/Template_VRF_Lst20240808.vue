    ...
    <div class="container py-2">
      ...
      option.vehicle_color }}</option>
                  ...
                  <div class="row p-2 pe-2 me-2">
                    ...
                    <div class="col-md-10 text-left border border-primary">
    ...
    setup() {
      ...
      const myRequest = async (keyword) => {
        ...
        try {
          ...
          await populateAreaNames(fetchedData);
  ...
  */
      ...
      const fetchAreaNames = async (vrfId) => {
        try {
          ...
          return response.data.map(area => area.area_name);
        } catch (error) {
      ...
      const addManualVRF = async () => {
        ...
        try {
          await axios.post(process.env.VUE_APP_API_URL + '/set_manual_add_vrf_template', json_formData)
            .then((res) => {
              // console.log('/set_manual_add_vrf_template res', res)
              id = res.data
              // console.log('/set_manual_add_vrf_template id = res.data', id)
              // Add the received id to json_formData
        ...
        //------------------------------------------add area--------------
        // try {
        //   await axios.post(process.env.VUE_APP_API_URL + '/set_vrf_area', json_formData)
        //     .then((res) => {
        //       //id = res.data
        //       console.log('/set_vrf_area response id: ', id)
        //     }, (res) => {
        //       console.error('/set_vrf_area error callback', res.data.message)
        //     })
        //     .catch((err) => {
        //       console.error('/set_vrf_area catch error', err)
        //     });
        //   error_addManual.value = false
        // } catch (err) {
        //   console.error('catch error', err)
