<template>
  ...
  <div class="container py-2">
    <div class="py-2">
      <form
        @submit.prevent="addManualVRF_validateInput"
          ...
          <div class="modal-dialog modalcustom">
            <div class="modal-content p-0 m-0">
              ...
              <div class="modal-body">
                ...
                <div
                  class="row ms-4 ps-4 pe-3 me-3 modalcustom scrollable-container"
                >
                      ...
                      <tr v-for="(data, index) in rowData" :key="data.Id">
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <option
                                v-for="option in data_ddl.prefix"
                                :value="option.id"
                                :key="option.id"
                              >
                                {{ option.prefix }}
                ...
                <div class="row p-2 pe-2 me-2">
                  ...
                  <div class="col-md-10 text-left">
                    ...
                    <MeetingArea
                      :items="MeetingArea_items"
                      :categoryLabels="categoryAreas"
                      :selectedItems="MeetingAreas_selectedItems"
                      @update:selectedItems="updateSelectedItems"
                      @remove:item="removeSelectedItem"
                      class="p-0 m-0"
                      style="width: auto"
                      :controlLabel="'พื้นที่ทั่วไป'"
                      :showSelectAll="false"
                    />
                  </div>
                </div>
                  ...
                  <div class="col-md-10 text-left h-auto">
                    <ul class="selected-items-list w-100 border border-gray">
                      ...
                      >
                        {{ item.name }}
                        <button
                          @click="removeSelectedControlItem(item)"
                          class="remove-button"
                        >
                          &times;
                        </button>
                ...
                <div class="row p-2 pe-2 me-2">
                  ...
                  <div class="col-md-10 text-left">
                    <MeetingArea
                      :items="MeetingControlArea_items"
                      :categoryLabels="categoryControlAreas"
                      :selectedItems="MeetingAreas_selectedControlItems"
                      @update:selectedItems="updateSelectedControlItems"
                      @remove:item="removeSelectedControlItem"
                      class="p-0 m-0"
                      style="width: auto"
                      :controlLabel="'พื้นที่ควบคุม'"
                      :showSelectAll="true"
                    />
                  </div>
                </div>
                ...
                <div class="row p-2 pe-2 me-2">
                  ...
                  <div class="col-md-2 text-left">
                    <datepicker
                      ...
                      style="width: 7rem"
                      inputFormat="dd/MM/yyyy"
                      @update:model-value="setFromDateAdd"
                    />
                    <p
                ...
                <div class="row p-2 pe-2 me-2">
                  ...
                  <div class="col-md-2 text-left">
                    ...
                    />
                    <p
                      v-if="VRF_error.template_name && !NewVrf.template_name"
                      class="error-message"
                    >
                      กรุณากรอกข้อมูล
                    </p>
                ...
                <div class="row p-2 pe-2 me-2">
                  ...
                  <div class="col-md-2 text-left">
                    <VueMultiselect
                      ...
                      :allow-empty="true"
                      :close-on-select="true"
                      :value="NewVrf.requestor_position.id"
                      track-by="id"
                      placeholder="เลือก"
                      :deselectLabel="null"
                    ></VueMultiselect>
                  ...
                  <div class="col-md-2 text-left">
                    <VueMultiselect
                      ...
                      :allow-empty="true"
                      :close-on-select="true"
                      :value="NewVrf.requestor_dept.id"
                      track-by="id"
                      placeholder="เลือก"
                      :deselectLabel="null"
                    ></VueMultiselect>
  ...
  <div class="container py-2">
    <div class="py-2">
      <form
        @submit.prevent="editVRF_validateInput"
        enctype="multipart/form-data"
        id="form2"
      >
                ...
                <div class="container modalcustom">
                    ...
                    <table class="table table-hover modalcustomtb">
                      ...
                      <tbody>
                        <tr
                          v-for="(
                            data, index
                          ) in templete_vrf_Existing.templete_vrf_Existing_det"
                          :key="index"
                        >
                          <td
                            scope="col"
                          ...
                          >
                            ...
                            >
                              <select
                                ...
                                v-model="
                                  templete_vrf_Existing
                                    .templete_vrf_Existing_det[index].prefix_id
                                "
                                style="width: 7rem; margin-right: 0.5rem"
                                @change="
                                  validateInput(
                              ...
                              <input
                                ...
                                v-model="
                                  templete_vrf_Existing
                                    .templete_vrf_Existing_det[index].fullname
                                "
                                @blur="
                                  edit_validateInput(
                                    'fullname',
                  ...
                  <div class="row p-2">
                    ...
                    <div class="col">
                      <datepicker
                        class="form-control"
                        v-model="useSetDate('date_from').value"
                        style="width: 7rem"
                        inputFormat="dd/MM/yyyy"
                    ...
                    <div class="col">
                      <datepicker
                        class="form-control"
                        v-model="useSetDate('date_to').value"
                        style="width: 7rem"
                        inputFormat="dd/MM/yyyy"
                  ...
                  <div class="row p-2">
                    ...
                    <div class="col">
                      ...
                      />
                      <p
                        v-if="VRF_error.reason && !templete_vrf_Existing.reason"
                        class="error-message"
                      >
                        กรุณากรอกข้อมูล
                      </p>
                  ...
                  <div class="row p-2">
                    ...
                    <div class="col">
                      <select
                        class="form-select form-select-sm"
                        v-model="templete_vrf_Existing.requestor_position_id"
                        style="width: 15rem; height: 2.5rem"
                      >
                        <option
                    ...
                    <div class="col">
                      <select
                        class="form-select form-select-sm"
                        v-model="templete_vrf_Existing.requestor_dept_id"
                        style="width: 15rem; height: 2.5rem"
                      >
                        <option
                  ...
                  <div class="row p-2">
                    ...
                    <div class="col">
                      <select
                        class="form-select form-select-sm"
                        v-model="templete_vrf_Existing.navigator_id"
                        style="width: 15rem; height: 2.5rem"
                      >
                        <option
...
export default defineComponent({
  ...
  setup() {
      ...
      columns: [
        ...
        },
        {
          ...
          display: function (row) {
            ...
            <div data-id="${
              row.id
            }" class="is-rows-el editvrf cursor-pointer" style="margin-top: 0.2rem; width: 5rem; height:2rem;  cursor: pointer;" data-bs-target="#ModalEditvrf" data-bs-toggle="modal">${
        ...
        },
        {
          ...
          display: function (row) {
            ...
            <div data-id="${
              row.id
            }" class="is-rows-el editvrf cursor-pointer" style="text-align: left; cursor: pointer;" data-bs-target="#ModalEditvrf" data-bs-toggle="modal">${
              row.area_names ? row.area_names.join(', ') : ''
            }</div>
    ...
    const edit_validateInput = (field, index, errorMessage) => {
      ...
      if (field === 'fullname') {
        const isDuplicate =
          templete_vrf_Existing.templete_vrf_Existing_det.some(
            (item, idx) =>
              idx !== index &&
              item.fullname ===
        ...
        if (isDuplicate) {
          ...
          if (
            templete_vrf_Existing.templete_vrf_Existing_det[index].errors &&
            templete_vrf_Existing.templete_vrf_Existing_det[index].errors[field]
          ) {
